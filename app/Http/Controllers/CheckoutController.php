...
class CheckoutController extends Controller
{
    ...
    // Memproses form checkout dan integrasi Midtrans
    public function store(Request $request, Event $event)
    {
        ...
        // Buat order ID dan total harga (harga tiket + biaya admin 5000)
        $orderId    = 'TRX-' . time() . '-' . Str::random(5);
        $totalPrice = $event->price + 5000;

        // Simpan transaksi ke database (status awal: Pending)
    ...
    // Menampilkan halaman pembayaran (dengan tombol Snap)
