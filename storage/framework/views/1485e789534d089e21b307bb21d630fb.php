...
<?php $__env->startSection('title', 'Edit Partner - Admin'); ?>

<?php $__env->startSection('page_title', 'Edit Partner'); ?>
<?php $__env->startSection('page_subtitle', 'Perbarui informasi partner yang sudah ada.'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-5xl mx-auto">
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-0">
        <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-4">
            <h2 class="text-white text-xl font-semibold">✏️ Edit Partner</h2>
            <p class="text-indigo-100 text-sm">Ubah data partner sesuai kebutuhan</p>
        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-5">
                        ...
                        <div class="bg-gray-50 rounded-xl p-5 text-center border border-dashed border-gray-300 hover:border-indigo-400 transition">
                            <div class="mb-3">
                                <div id="logoPreview" class="w-28 h-28 mx-auto rounded-full bg-gray-200 flex items-center justify-center text-4xl overflow-hidden">
                                    <?php if($partner->logo_path): ?>
                                        <img src="<?php echo e(asset('storage/' . $partner->logo_path)); ?>" class="w-full h-full object-cover rounded-full">
                                    <?php else: ?>
                                        🖼️
                                    <?php endif; ?>
                                </div>
                            </div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1"><?php echo e($partner->logo_path ? 'Ganti Logo' : 'Upload Logo'); ?></label>
                            ...
                            <p class="text-xs text-gray-400 mt-2">JPEG, PNG, GIF. Max 2MB. Kosongkan jika tidak ingin mengubah.</p>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="bg-gray-50 rounded-xl p-5 flex items-center justify-between">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_active" value="1" class="sr-only peer" <?php echo e(old('is_active', $partner->is_active) ? 'checked' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select name="type" required class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">
                                    ...
                                    <?php $__currentLoopData = ['Game Partner', 'Educational Partner', 'Startup Partner', 'Music Partner', 'Art Partner']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type); ?>" <?php echo e(old('type', $partner->type) == $type ? 'selected' : ''); ?>><?php echo e($type); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"><?php echo e(old('description', $partner->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="url" name="website" value="<?php echo e(old('website', $partner->website)); ?>" placeholder="https://example.com"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="email" name="contact_email" value="<?php echo e(old('contact_email', $partner->contact_email)); ?>"
                                    class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="contact_phone" value="<?php echo e(old('contact_phone', $partner->contact_phone)); ?>"
                                    class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">
...
<script>
    document.getElementById('logoInput').addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            // Jika tidak ada file baru, kembalikan ke logo lama jika ada
            <?php if($partner->logo_path): ?>
                preview.innerHTML = `<img src="<?php echo e(asset('storage/' . $partner->logo_path)); ?>" class="w-full h-full object-cover rounded-full">`;
            <?php else: ?>
                preview.innerHTML = '🖼️';
            <?php endif; ?>
        }
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eventamikom-3389\resources\views/admin/partners/edit.blade.php ENDPATH**/ ?>