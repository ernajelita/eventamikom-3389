...
<?php $__env->startSection('title', 'Pembayaran - ' . $transaction->event->title); ?>
...
<main class="max-w-3xl mx-auto px-6 py-20 text-center">
    <div class="bg-white rounded-3xl border border-slate-200 p-12 shadow-sm inline-block w-full max-w-md">
        ...
        <p class="text-slate-500 mb-8">Mohon selesaikan pembayaran tiket Anda untuk event <strong><?php echo e($transaction->event->title); ?></strong>.</p>
        ...
        <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 mb-8">
            ...
            <h3 class="text-4xl font-extrabold text-indigo-600">Rp <?php echo e(number_format($transaction->total_price, 0, ',', '.')); ?></h3>
            <p class="text-xs text-slate-400 mt-2">Order ID: <?php echo e($transaction->order_id); ?></p>
        </div>
    ...
    document.getElementById('pay-button').onclick = function () {
        snap.pay('<?php echo e($transaction->snap_token); ?>', {
            onSuccess: function(result){
                window.location.href = "<?php echo e(route('checkout.success', $transaction->order_id)); ?>";
            },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eventamikom-3389\resources\views/checkout/payment.blade.php ENDPATH**/ ?>