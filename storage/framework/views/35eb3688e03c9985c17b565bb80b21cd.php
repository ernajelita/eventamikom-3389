...
<div class="bg-white rounded-[2.5rem] border border-slate-100 p-10 shadow-sm max-w-4xl">
    <form action="<?php echo e(route('admin.events.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="flex justify-end gap-4 mt-8">
            <a href="<?php echo e(route('admin.events.index')); ?>" class="px-6 py-3 font-bold text-slate-400">Batal</a>
...
<?php echo $__env->make('layouts.admin', ['title' => 'Tambah Event'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eventamikom-3389\resources\views/admin/events/create.blade.php ENDPATH**/ ?>