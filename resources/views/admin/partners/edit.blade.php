...
@section('page_subtitle', 'Perbarui informasi partner yang sudah ada.')
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-5">
                        {{-- Card Upload Logo dengan preview --}}
                            ...
                            <div class="mb-3">
                                <div id="logoPreview" class="w-28 h-28 mx-auto rounded-full bg-gray-200 flex items-center justify-center text-4xl overflow-hidden">
                                    @if($partner->logo_path)
                                        <img src="{{ asset('storage/' . $partner->logo_path) }}" class="w-full h-full object-cover rounded-full">
                                    @else
                                        🖼️
                                    @endif
                                </div>
                            </div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1">{{ $partner->logo_path ? 'Ganti Logo' : 'Upload Logo' }}</label>
                    ...
                    <div class="lg:col-span-2 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200">{{ old('description', $partner->description) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="url" name="website" value="{{ old('website', $partner->website) }}" placeholder="https://example.com"
...
<script>
    document.getElementById('logoInput').addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            @if($partner->logo_path)
                preview.innerHTML = `<img src="{{ asset('storage/' . $partner->logo_path) }}" class="w-full h-full object-cover rounded-full">`;
            @else
                preview.innerHTML = '🖼️';
            @endif
        }
