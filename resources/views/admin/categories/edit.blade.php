...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}"
                           class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 outline-none transition @error('name') border-red-500 ring-red-100 @enderror"
            ...
            {{-- Slug URL (otomatis dari nama, bisa diedit manual) --}}
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug', $category->slug) }}"
                           class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100 outline-none transition font-mono text-sm @error('slug') border-red-500 ring-red-100 @enderror"
            ...
            {{-- Gambar Kategori dengan Preview di Samping --}}
            <div class="mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                    ...
                    <div class="flex gap-3 items-center flex-shrink-0">
                        ...
                        <div id="currentImagePreview" class="w-16 h-16 rounded-xl overflow-hidden border border-slate-200 bg-slate-50 shadow-sm">
                            <img src="{{ asset('storage/' . $category->image) }}" class="w-full h-full object-cover" alt="Current image">
                        </div>
                        @endif
                ...
                <div class="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs">
                    ...
                    <span class="text-slate-500 flex items-center gap-1">
                        ...
                        <a href="{{ asset('storage/' . $category->image) }}" target="_blank" class="text-indigo-600 hover:underline">Lihat gambar asli</a>
                    </span>
                    @endif
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-100">
                <a href="{{ route('admin.categories') }}" class="inline-flex justify-center items-center gap-2 px-6 py-2.5 border border-slate-200 text-slate-600 rounded-xl font-semibold hover:bg-slate-50 transition">
